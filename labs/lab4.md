...
- **Work on the new folder created for this lab:** lab4. You have to click Sync Fork on your github account and type "github pull" in your local so that your local is in sync with the fork you just synched.
